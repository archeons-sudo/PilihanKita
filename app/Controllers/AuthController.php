...
class AuthController extends BaseController
{
    ...
    {
        try {
            // Get Google user data from callback
            // For demo purposes, we'll simulate this
            // In production, you would use Google API Client here
            
            if (!$this->request->getGet('code')) {
                throw new \Exception('Authorization code not received');
            }

            // Simulate Google user data (replace with actual Google API call)
            $googleUser = [
                'id' => $this->request->getGet('code'), // This would be actual Google ID
            ...
            // Check if student exists by Google ID
            ...
            if (!$student) {
                ...
                if ($student) {
                    // Update Google ID for existing student
    ...
    public function adminAuth()
    {
        try {
            ...
            log_message('error', 'Admin Auth Error: ' . $e->getMessage());
